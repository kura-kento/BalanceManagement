...
//     final result = await this.database.rawQuery('SELECT * FROM $tableName WHERE id = ?', [id]);
//     return result;
//   }
//   //idと同じデータを持ってくる。
//   Future <Category> getCategoryId(value) async {
//     final categoryMapList = await getCategoryMapWhere(value); // Get 'Map List' from database
...
//     final result = await this.database.insert(tableName, category.toMap());
//     return result;
//   }
//
//   // Update Operation: Update a Note object and save it to database
//   Future<int> updateCategory(Category category) async {
//     final result = await this.database.update(tableName, category.toMap(), where: '$colId = ?', whereArgs: [category.id]);
//     return result;
//   }
//
